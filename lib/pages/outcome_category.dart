...
class _ExpenseCategoryPageState extends State<ExpenseCategoryPage> {
  late Future<List<Map<String, dynamic>>> _expenseCategoriesFuture;
  ...
  void _refreshCategories() {
    setState(() {
      _expenseCategoriesFuture = DBHelper.getExpenseCategories();
    });
  }
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    if (categoryName.isNotEmpty) {
                      await DBHelper.insertExpenseCategory(
                        categoryName,
                        icon: selectedIcon,
                      );
  ...
  void _showDeleteConfirmationDialog(int id, String code) {
    final l10n = AppLocalizations.of(context)!;
    final colors = widget.isDark ? dark.darkColors : light.lightColors;
    final displayName = CategoryUI.getName(l10n, code);
